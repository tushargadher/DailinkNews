...
export default class NewsItem extends Component {
    ...
    render() {
        ...
        let { img, title, url, publishDate,source } = this.props; //publishedAt for include date in 
        return (

            <div className="relative min-h-fit h-96 w-96 m-4  p-5 flex flex-col justify-between items-center bg-white border-gray-200 rounded-lg shadow-md dark:bg-gray-600 dark:border-gray-700">
                ...
                {/* <button className="bg-slate-600 text-slate-50 p-2"onClick={this.changeValue}>Change Image</button> */}
            </div>
